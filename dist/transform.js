...
var i18nTransform = /*#__PURE__*/ (function (_Transform) {
  ;(0, _inherits2['default'])(i18nTransform, _Transform)
  var _super = _createSuper(i18nTransform)
  function i18nTransform() {
    var _this
    var options =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
    ;(0, _classCallCheck2['default'])(this, i18nTransform)
    ...
    _this.i18next = _i18next['default'].createInstance()
    _this.i18next.init(_this.options.i18nextOptions)
    return _this
  }
  ;(0, _createClass2['default'])(i18nTransform, [
    {
      key: 'error',
    ...
    {
      key: '_pathFragment',
      value: function _pathFragment(filePath) {
        var fragment =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : 'first'
        var rootPath = _path['default'].dirname(filePath)
        var dirname = rootPath.replace(this.options.namespaceSourceBasePath, '')
        var split = dirname.split(_path['default'].sep)
        switch (fragment) {
          case 'first':
            return split[0]
          case 'last':
            ...
            for (var namespace in catalog) {
              ...
              if (_this2.options.verbose) {
                ...
                console.log(
                  'Unique keys: '
                    .concat(uniqueCount, ' (')
                    .concat(countWithPlurals, ' with plurals)')
                )
              ...
              if (_this2.options.failOnUpdate) {
                var _addCount = countWithPlurals - mergeCount
              ...
              if (sort) {
                var compare =
                  typeof sort === 'function'
                    ? sort
                    : (0, _helpers.makeDefaultSort)(
                        _this2.options.pluralSeparator
                      )
                maybeSortedNewCatalog = (0, _sortKeys['default'])(newCatalog, {
                  deep: true,
                  compare: compare,
                })
                maybeSortedOldCatalog = (0, _sortKeys['default'])(oldCatalog, {
                  deep: true,
                  compare: compare,
                })
              }
      ...
      value: function getCatalog(path) {
        try {
          ...
          if (path.endsWith('yml')) {
            content = _jsYaml['default'].load(
              _fs['default'].readFileSync(path).toString()
            )
          } else {
