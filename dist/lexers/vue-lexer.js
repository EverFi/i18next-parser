...
var _javascriptLexer = _interopRequireDefault(require('./javascript-lexer.js'))
...
var VueLexer = /*#__PURE__*/ (function (_BaseLexer) {
  ;(0, _inherits2['default'])(VueLexer, _BaseLexer)
  var _super = _createSuper(VueLexer)
  function VueLexer() {
    var _this
    var options =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
    ;(0, _classCallCheck2['default'])(this, VueLexer)
    _this = _super.call(this, options)

    _this.functions = options.functions || ['$t']
    return _this
  }
  ;(0, _createClass2['default'])(VueLexer, [
    {
      key: 'extract',
      value: function extract(content, filename) {
        ...
        var Lexer2 = new _javascriptLexer['default']({
