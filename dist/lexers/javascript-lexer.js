...
var _baseLexer = _interopRequireDefault(require('./base-lexer'))
...
var JavascriptLexer = /*#__PURE__*/ (function (_BaseLexer) {
  ;(0, _inherits2['default'])(JavascriptLexer, _BaseLexer)
  var _super = _createSuper(JavascriptLexer)
  function JavascriptLexer() {
    var _this
    var options =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
    ;(0, _classCallCheck2['default'])(this, JavascriptLexer)
  ...
  ;(0, _createClass2['default'])(JavascriptLexer, [
    {
            ...
            function (pos, end, kind) {
              ...
              if (
                ...
                if (commentKeys) {
                  keys.push.apply(
                    keys,
                    (0, _toConsumableArray2['default'])(commentKeys)
                  )
                }
              }
            }
        ...
        if (isTranslationFunction) {
          ...
          if (this.parseGenerics && node.typeArguments) {
            ...
            var parseTypeArgument = function parseTypeArgument(typeArg) {
              ...
              if (typeArg.kind === ts.SyntaxKind.TypeLiteral) {
                ...
                if (typeName in _this5.typeMap) {
                  Object.assign(entry, _this5.typeMap[typeName])
                }
          ...
          if (entry.ns) {
            if (typeof entry.ns === 'string') {
              ...
              (0, _typeof2['default'])(entry.ns) === 'object' &&
              entry.ns.length
            ) {
    ...
    },
    {
      ...
      value: function commentExtractor(commentText) {
        ...
        expressions.forEach(function (expression) {
          var expressionKeys = _this6.extract(expression)
          if (expressionKeys) {
            keys.push.apply(
              keys,
              (0, _toConsumableArray2['default'])(expressionKeys)
            )
          }
        })
        return keys
