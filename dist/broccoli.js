...
var i18nextParser = /*#__PURE__*/ (function (_Plugin) {
  ;(0, _inherits2['default'])(i18nextParser, _Plugin)
  var _super = _createSuper(i18nextParser)
  function i18nextParser(inputNodes) {
    var _this
    var options =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
    ;(0, _classCallCheck2['default'])(this, i18nextParser)
    _this = _super.apply(this, arguments)
    _this.options = options
    return _this
  }
  ;(0, _createClass2['default'])(i18nextParser, [
    {
      key: 'build',
            ...
            .pipe(
              new _transform['default'](_this2.options)
                ...
                .on('data', function (file) {
                  files.push(
                    _fsExtra['default'].outputFile(file.path, file.contents)
                  )
                  if (!this.options.silent) {
...
})(_broccoliPlugin['default'])
exports['default'] = i18nextParser
