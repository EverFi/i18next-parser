...
exports.dotPathToHash = dotPathToHash
exports.getPluralSuffixPosition = getPluralSuffixPosition
exports.getSingularForm = getSingularForm
exports.hasRelatedPluralKey = hasRelatedPluralKey
exports.makeDefaultSort = makeDefaultSort
exports.mergeHashes = mergeHashes
exports.transferValues = transferValues
...
function dotPathToHash(entry) {
  ...
  if (oldValue !== undefined && oldValue !== newValue) {
    if (
      (0, _typeof2['default'])(oldValue) !== (0, _typeof2['default'])(newValue)
    ) {
      conflict = 'key'
    } else if (oldValue !== '') {
      if (newValue === '') {
...
function mergeHashes(source, target) {
  ...
  for (var key in source) {
    var hasNestedEntries =
      (0, _typeof2['default'])(target[key]) === 'object' &&
